...
var toggleSitesList = 'example.com'; // replace the initial values above with ondes from synced storage
...
chrome.webRequest.onBeforeRequest.addListener(function (details) {
  ...
  urls: ["<all_urls>"]
}, ["blocking"]); // any time that a storage item is updated, update the global variable
